...
class Trainer:
    ...
    def _multi_train(self, save_dir, batch_gen, batch_size, learning_rate, iter_times):
        self.model = MultiStageModel(self.num_blocks, self.num_layers, self.num_f_maps, self.dim, self.num_classes)
        ...
        batch_gen.save_pseudo_labels(save_dir)
        for epoch in range(1, self.num_epochs+1):
            ...
            while batch_gen.has_next():
                ...
                _, seq_lengths, timestamps = batch_gen.get_useful_info()
